            ...
            <c:forEach items="${sessionScope.cart}" var="c">
                <tr>
                    ...
                    <td style="border-right: 1px solid gray;">
                        <a href="${pageContext.request.contextPath}/CartServlet?method=del&pid=${c.key.pro_id}" class="delete">删除</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
        ...
        <table style="margin:0 auto; margin-top:10px;width:950px;">
            ...
            <tr>
                <td style="text-align: right" colspan="100%">
                    商品金额: <strong style="color:#ff6600;">￥${sessionScope.total}元</strong>
                </td>
        ...
        <table style="margin:0 auto; margin-top:10px;width:950px;">
            ...
            <tr>
                <td style="text-align: right" colspan="100%">
                    ...
                    <a href="${pageContext.request.contextPath}/jsp/pay.jsp">
