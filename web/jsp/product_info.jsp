            ...
            <div class="container">
                <div class="row">
                    ...
                    <div style="margin:0 auto;width:950px;"style="float:left;">
                        <div class="col-md-6">
                            <img style="opacity: 1;width:400px;height:350px;" title="" class="medium" src="${pageContext.request.contextPath}/${requestScope.p.pro_min_img}">
                            ...
                            <div class="col-md-6" style="float: right;">
                                ...
                                <div style="margin:10px 0 10px 0;">亿家价: <strong style="color:#ef0101;">￥：${requestScope.p.shop_price}</strong> 参 考 价： <del>￥:${requestScope.p.market_price}</del>
                                </div>
                             ...
                             <form action="${pageContext.request.contextPath}/CartServlet?method=add" method="post">
                                 <input type="hidden" name="pid" value="${requestScope.p.pro_id}" />
                    ...
                    <div style="width:950px;margin:0 auto;">
                        ...
                        <div>
                            <img src="${pageContext.request.contextPath}/${requestScope.p.pro_min_img}" width="300px" height="500px">
                        </div>
                    </div>
