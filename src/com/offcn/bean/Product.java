...
public class Product {
    ...
    public Product(int pro_id, String pro_name, String pro_num, int market_price, int shop_price, String pro_color, int pro_total_count, String pro_max_img, String pro_min_img, int pro_state) {
        this.pro_id = pro_id;
